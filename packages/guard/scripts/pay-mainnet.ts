/**
 * Buyer-side proof on X Layer MAINNET: a buyer-agent calls the LIVE Frisk ASP, auto-pays the
 * x402 fee in mainnet USDT0, and gets back a signed verdict. Full two-sided loop, real settlement.
 *
 *   FRISK_KEY_PK=0x... node --import tsx scripts/pay-mainnet.ts
 */
